...
public class TriDiButTwo : MonoBehaviour
{
    ...
    void OnMouseUp()
    {
        ...
        if (BallManagerTwo.controLock == false)
        {
            BallManagerTwo.POWAAA = kekuatan;
            BallManagerTwo.isLaunching = true;
            BallManagerTwo.controLock = true;
        }
    }
}
